...
BLOG_AUTHOR = "Pritam Dey"  # (translatable)
...
# BASE_URL = "resume/"
BLOG_EMAIL = "pritam.pritamdey.984@gmail.com"
BLOG_DESCRIPTION = "Resume of Pritam Dey"  # (translatable)
